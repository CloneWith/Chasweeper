...
class Board:
    ...
    def award_bonus_points(self):
        ...
        if words_left == 3 and self.random_click_counter <= self.random_click_cap:
            self.score += 1500 * max(1, (self.random_click_cap - self.random_click_counter))  # Stage 3 bonus points
        elif words_left == 2 and self.random_click_counter <= self.random_click_cap:
            self.score += 1800 * max(1, (self.random_click_cap - self.random_click_counter)) # Stage 4 bonus points
        elif words_left == 1 and self.random_click_counter <= self.random_click_cap:
            self.score += 2000 * max(1, (self.random_click_cap - self.random_click_counter)) # Stage 5 bonus points
